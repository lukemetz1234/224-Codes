...
## To use## This file is a general .xdc for the Basys3 rev B board
...
##Sch name = JC2
#set_property PACKAGE_PIN M18 [get_ports {R_nW}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {R_nW}]
##Sch name = JC3
...
set_property PACKAGE_PIN L17 [get_ports {RS}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {RS}]
##Sch name = JC8
set_property PACKAGE_PIN M19 [get_ports {R_nW}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {R_nW}]
##Sch name = JC9
